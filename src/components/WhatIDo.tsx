        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building robust, scalable AI/ML solutions, full-stack web applications, and data pipelines from end to end.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Crafting intuitive user interfaces, product requirements, and designing seamless interaction flows.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
